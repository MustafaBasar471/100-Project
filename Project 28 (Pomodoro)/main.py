...
title_label = Label(text="Timer", bg=PINK, highlightthickness=0, fg=GREEN, font=(FONT_NAME, 35, "bold"))
...
timer_txt = canvas.create_text(100, 125, text="00:00", fill="white", font=(FONT_NAME, 30, "bold"))
...
check = Label(fg=GREEN, bg=PINK, font=(FONT_NAME, 20))
